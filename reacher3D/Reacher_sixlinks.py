...
class ReacherEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.j4.attach(self.body7,self.body4)
        self.j4.setFixed()
    ...
    def _step(self,(jas,jvs,target_ja,torques)):
        if(self.controlMode=="POS"):
            ...
            self.j6.addTorque(output_torques[4])
            self.j7.addTorque(output_torques[5])
        ...
        if(self.controlMode=="POS-IMG"):
            ...
            self.j6.addTorque(torques[4])
            self.j7.addTorque(torques[5])
